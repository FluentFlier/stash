...
| `auto_folder/` | **Hierarchical auto-foldering system** (see below) |
| `requirements.txt` | Python dependencies |

## Auto-Folder System

The `auto_folder/` module provides intelligent categorization of saved items into a hierarchical folder structure.

### Quick Usage

```bash
# Process a downloader output
python -m auto_folder processes/outputs/twitter_tweet_data

# Direct classification
python -m auto_folder --topic "calorie deficit" --summary "Notes on maintaining..."
...
# Initialize (auto-creates seed folders on first run)
auto_folder = AutoFolder()

# Classify an item
result = auto_folder.classify(ItemInput(
    item_id="123",
    raw_topic="calorie deficit",
    summary="Notes on maintaining a calorie deficit..."
))

print(result.final_path)  # "Health & Fitness/Weight Loss"
print(result.tags)        # ["calorie deficit", "nutrition", "fat loss"]
```
...
{
  "item_id": "123",
  "final_path": "Health & Fitness/Weight Loss",
  "created_folders": [],
  "reused_folders": ["Health & Fitness", "Health & Fitness/Weight Loss"],
  "applied_labels": {"domain": "Health & Fitness", "subdomain": "Weight Loss"},
  "tags": ["calorie deficit", "nutrition", "fat loss"],
  "confidence": 0.86,
  "notes": "Reused existing Weight Loss folder"
}
```

See `auto_folder/README.md` for full documentation.
